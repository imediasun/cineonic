<template>
  ...
  <BaseCard
    ...
    subtitle="The individual radio inputs in <b-form-radio-group> can be specified via the options prop, or via manual placement of the <b-form-radio> sub component. "
    modalid="modal-2"
    modaltitle="Grouped radios"
  >
    <!-- --------------------------
    code view
    ---------------------------- -->
