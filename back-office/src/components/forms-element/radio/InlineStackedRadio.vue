<template>
  ...
  <BaseCard
    ...
    subtitle="By default <b-form-radio-group> generates inline radio inputs, while <b-form-radio> generates stacked radios."
    modalid="modal-4"
    modaltitle="Inline or stacked radios"
  >
    <!-- --------------------------
    code view
    ---------------------------- -->
