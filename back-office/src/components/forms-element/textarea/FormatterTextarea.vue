<template>
  ...
  <!-- ----------------------------------------------------------------------------- -->
  <BaseCard
    title="Formatter support"
    subtitle="<b-form-textarea> optionally supports formatting by passing a function reference to the formatter prop."
    modalid="modal-6"
    modaltitle="Formatter support"
  >
    <!-- --------------------------
    code view
    ---------------------------- -->
