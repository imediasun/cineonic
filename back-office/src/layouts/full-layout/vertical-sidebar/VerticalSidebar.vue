<template>
  ...
  >
    <div :class="`bg-${logoColor} navbar-header overflow-hidden`">
      <div  class="logo-icon" v-if="LayoutType === 'mini-sidebar'">
        <img height="25px"  width="25px" style="margin-left: 12px; background-repeat: no-repeat;overflow: hidden;" src="../../../assets/images/logo.png" alt="homepage" >
      </div>
      <div v-else>
...
export default {
  ...
  computed: {
    ...mapState(["logoColor", "Sidebar_drawer", "SidebarColor", "LayoutType"]),
